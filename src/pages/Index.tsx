...
const HERO_IMG = "https://cdn.poehali.dev/projects/00655993-1a8e-409b-8656-b97f8fa9c9c0/files/5b63c5dc-f736-4e71-befa-2236a37359a2.jpg";
    ...
    <div className="min-h-screen bg-stone-950 text-stone-100 font-golos">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-stone-950/80 backdrop-blur-md border-b border-emerald-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 flex items-center justify-between h-16">
          <div className="flex items-center">
            <img src="https://cdn.poehali.dev/projects/00655993-1a8e-409b-8656-b97f8fa9c9c0/bucket/a75d4161-465f-47dd-9210-0d2eeb7d3a51.jpg" alt="СК Малахит 39" className="h-10 w-auto object-contain" />
          </div>
      ...
      <footer className="bg-stone-900 border-t border-stone-800 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center">
            <img src="https://cdn.poehali.dev/projects/00655993-1a8e-409b-8656-b97f8fa9c9c0/bucket/a75d4161-465f-47dd-9210-0d2eeb7d3a51.jpg" alt="СК Малахит 39" className="h-8 w-auto object-contain" />
          </div>
