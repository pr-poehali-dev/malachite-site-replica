      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-stone-950/80 backdrop-blur-md border-b border-emerald-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            <span className="font-black text-sm tracking-widest text-white uppercase leading-tight">СК Малахит<br/><span className="text-emerald-400">39</span></span>
          </div>
      ...
      <footer className="bg-stone-900 border-t border-stone-800 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-black text-xs tracking-widest text-white uppercase leading-tight">СК Малахит <span className="text-emerald-400">39</span></span>
          </div>
